...
public:
    ...
    {
        AboutDialog->setWindowTitle(QApplication::translate("AboutDialog", "About Lexium Core", 0));
        label->setText(QApplication::translate("AboutDialog", "<b>Lexium Core</b> version", 0));
...
"Copyright &copy; 2014-YYYY The Lexium Core developers.", 0));
