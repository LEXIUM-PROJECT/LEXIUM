...
#ifndef QT_NO_TOOLTIP
        messageTextLabel->setToolTip(QApplication::translate("SendCoinsEntry", "A message that was attached to the lexium: URI which will be stored with the transaction for your reference. Note: This message will not be sent over the Lexium network.", 0));
#endif // QT_NO_TOOLTIP
#ifndef QT_NO_TOOLTIP
