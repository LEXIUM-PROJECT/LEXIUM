...
[From the lexium github repo](https://github.com/darkcoin/darkcoin/blob/master/doc/masternode_conf.md)
...
## What about the lexium.conf file?

If you are using a masternode.conf file you no longer need the lexium.conf file. The exception is if you need custom settings (thanks oblox). 

## Update lexium.conf on server

If you generated a new masternode private key, you will need to update the remote lexium.conf files.

Shut down the daemon and then edit the file.

```sudo nano .lexium/lexium.conf```

### Edit the masternodeprivkey
If you generated a new masternode private key, you will need to update the masternodeprivkey value in your remote lexium.conf file.
