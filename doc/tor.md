...
It is possible to run Lexium as a Tor hidden service, and connect to such services.
...
The first step is running Lexium behind a Tor proxy. This will already make all
