...
##perform gitian builds
 ...
 Build lexiumd and lexium-qt on Linux32, Linux64, and Win32:

	./bin/gbuild --commit lexium=v${VERSION} ../lexium/contrib/gitian-descriptors/gitian-linux.yml
	./bin/gsign --signer $SIGNER --release ${VERSION} --destination ../gitian.sigs/ ../lexium/contrib/gitian-descriptors/gitian-linux.yml
	pushd build/out
	zip -r lexium-${VERSION}-linux-gitian.zip *
	mv lexium-${VERSION}-linux-gitian.zip ../../../
	popd
	./bin/gbuild --commit lexium=v${VERSION} ../lexium/contrib/gitian-descriptors/gitian-win.yml
	./bin/gsign --signer $SIGNER --release ${VERSION}-win --destination ../gitian.sigs/ ../lexium/contrib/gitian-descriptors/gitian-win.yml
	pushd build/out
	zip -r lexium-${VERSION}-win-gitian.zip *
	mv lexium-${VERSION}-win-gitian.zip ../../../
	popd
    ./bin/gbuild --commit lexium=v${VERSION} ../lexium/contrib/gitian-descriptors/gitian-osx-bitcoin.yml
