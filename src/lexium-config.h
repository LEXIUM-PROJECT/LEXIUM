/* src/lexium-config.h.  Generated from lexium-config.h.in by configure.  */
/* src/lexium-config.h.in.  Generated from configure.ac by autoheader.  */

#ifndef LEXIUM_CONFIG_H

#define LEXIUM_CONFIG_H
...
#define PACKAGE_BUGREPORT "info@lexium.org"

/* Define to the full name of this package. */
#define PACKAGE_NAME "Lexium Core"

/* Define to the full name and version of this package. */
#define PACKAGE_STRING "Lexium Core 0.9.3"

/* Define to the one symbol short name of this package. */
#define PACKAGE_TARNAME "lexium"
