    ...
    spinnerFrame(0)
{
    ...
    QString windowTitle = tr("Lexium Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions(bool fIsTestnet)
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a Lexium address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and lexium: URIs)"));
    ...
    if (!fIsTestnet)
        aboutAction = new QAction(QIcon(":/icons/bitcoin"), tr("&About Lexium Core"), this);
    else
        aboutAction = new QAction(QIcon(":/icons/bitcoin_testnet"), tr("&About Lexium Core"), this);
    aboutAction->setStatusTip(tr("Show information about Lexium"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for Lexium"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your Lexium addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/verify"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified Lexium addresses"));
    ...
    openAction->setStatusTip(tr("Open a lexium: URI or payment request"));

    showHelpMessageAction = new QAction(QIcon(":/icons/info"), tr("&Command-line options"), this);
    showHelpMessageAction->setStatusTip(tr("Show the Lexium Core help message to get a list with possible Lexium command-line options"));
...
void BitcoinGUI::createTrayIcon(bool fIsTestnet)
{
    ...
    if (!fIsTestnet)
    {
        trayIcon->setToolTip(tr("Lexium client"));
        trayIcon->setIcon(QIcon(":/icons/toolbar"));
    }
    else
    {
        trayIcon->setToolTip(tr("Lexium client") + " " + tr("[testnet]"));
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to Lexium network", "", count));
}
...
{
    QString strTitle = tr("Lexium"); // default title
